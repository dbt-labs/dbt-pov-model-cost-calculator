...
4. **After you've collected baseline and SAO runs, execute the following:**\
   The below summary date variables give you flexibility to calculate your aggregate savings summary across a defined timeframe. If no variables are passed in, the agg_savings_summary_warehouse model will calculate over the last full 7 days.
    ```bash
